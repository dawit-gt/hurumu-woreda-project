...
let DepartmentsController = exports.DepartmentsController = class DepartmentsController {
    ...
    findOne(slug) { return this.departmentsService.findOne(slug); }
    create(dto) { return this.departmentsService.create(dto); }
    update(id, dto) { return this.departmentsService.update(id, dto); }
    remove(id) { return this.departmentsService.remove(id); }
};
__decorate([
